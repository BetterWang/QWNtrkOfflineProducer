...
config.General.requestName = 'PABptx_ZDC_v1'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qw_pPb16_ZDC_Bptx_v1.py'
config.Data.inputDataset = '/PAEmptyBX/PARun2016C-PromptReco-v1/AOD'
