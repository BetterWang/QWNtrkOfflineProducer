...
process.path0_5  = cms.Path(process.Centrality0_5  *process.QWGenEvent*process.Mon0_5)
process.path5_10 = cms.Path(process.Centrality5_10 *process.QWGenEvent*process.Mon5_10)
process.path10_20= cms.Path(process.Centrality10_20*process.QWGenEvent*process.Mon10_20)
process.path20_30= cms.Path(process.Centrality20_30*process.QWGenEvent*process.Mon20_30)
process.path30_40= cms.Path(process.Centrality30_40*process.QWGenEvent*process.Mon30_40)
process.path40_50= cms.Path(process.Centrality40_50*process.QWGenEvent*process.Mon40_50)
process.path50_60= cms.Path(process.Centrality50_60*process.QWGenEvent*process.Mon50_60)
process.path60_70= cms.Path(process.Centrality60_70*process.QWGenEvent*process.Mon60_70)
process.path70_80= cms.Path(process.Centrality70_80*process.QWGenEvent*process.Mon70_80)
process.path80_90= cms.Path(process.Centrality80_90*process.QWGenEvent*process.Mon80_90)
process.path90_100=cms.Path(process.Centrality90_100*process.QWGenEvent*process.Mon90_100)
