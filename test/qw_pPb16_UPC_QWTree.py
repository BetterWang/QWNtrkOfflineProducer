...
process.QWPFGapForward = cms.EDFilter('QWDoubleFilter',
        src = cms.untracked.InputTag('QWPFgap', 'FRG'),
        dmin = cms.untracked.double(5.),
        dmax = cms.untracked.double(10.0)
        )

process.QWPFGapBackward = cms.EDFilter('QWDoubleFilter',
        src = cms.untracked.InputTag('QWPFgap', 'BRG'),
        dmin = cms.untracked.double(5.),
        dmax = cms.untracked.double(10.0)
        )

process.monFRG = cms.EDAnalyzer('QWHistDAnalyzer',
		src = cms.untracked.InputTag('QWPFgap', 'FRG'),
		Nbins = cms.untracked.int32(20),
		start = cms.untracked.double(0.),
		end = cms.untracked.double(10.),
		)

process.monBRG = cms.EDAnalyzer('QWHistDAnalyzer',
		src = cms.untracked.InputTag('QWPFgap', 'BRG'),
		Nbins = cms.untracked.int32(20),
		start = cms.untracked.double(0.),
		end = cms.untracked.double(10.),
...
process.RECO = cms.OutputModule("PoolOutputModule",
                outputCommands = cms.untracked.vstring('keep *_*_*_CumuV3'),
                SelectEvents = cms.untracked.PSet(
                        SelectEvents = cms.vstring('anaPF')
                        ),
...
process.QWEvent.ptMax = cms.untracked.double(1000.)

process.QWTree = cms.EDAnalyzer('QWTreeMaker',
		src = cms.untracked.InputTag('QWEvent'),
		vTag = cms.untracked.vstring('phi', 'eta', 'pt', 'charge', 'px', 'py', 'pz', 'weight')
		)

process.out = cms.EndPath(process.RECO)

process.anaTree = cms.Path( process.hltMB * process.eventSelection * process.QWPFgap * process.QWPFGapForward * process.selection0N 
		* process.Noff
		* process.QWEvent
		* process.vectMonW
		* process.QWTree
		* process.monSumN * process.monFRG * process.monBRG )
