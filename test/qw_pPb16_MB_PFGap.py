...
process.anaPF = cms.Path( process.hltMB * process.eventSelection * process.QWPFgap * process.QWZDC * process.monSumN * process.monFRG * process.monBRG)
