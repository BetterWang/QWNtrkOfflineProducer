...
#        fileNames = cms.untracked.vstring("file:/afs/cern.ch/user/q/qwang/work/cleanroomRun2/Ana/CMSSW_7_5_8_patch2/src/QWAna/QWCumuV3/test/HIMinBias_28.root")
	fileNames = cms.untracked.vstring("file:/afs/cern.ch/work/q/qwang/public/PbPb2015_tracking/hydjet_pixel.root")
)
...
process.load('PbPb_HIMB2_general_noeff')
...
process.p  = cms.Path(process.QWEvent)
process.path0_5  = cms.Path(process.hltMB*process.eventSelection*process.centralityBin*process.Centrality0_5  *process.QWEvent*process.Mon0_5)
process.path5_10 = cms.Path(process.hltMB*process.eventSelection*process.centralityBin*process.Centrality5_10 *process.QWEvent*process.Mon5_10)
process.path10_20= cms.Path(process.hltMB*process.eventSelection*process.centralityBin*process.Centrality10_20*process.QWEvent*process.Mon10_20)
process.path20_30= cms.Path(process.hltMB*process.eventSelection*process.centralityBin*process.Centrality20_30*process.QWEvent*process.Mon20_30)
process.path30_40= cms.Path(process.hltMB*process.eventSelection*process.centralityBin*process.Centrality30_40*process.QWEvent*process.Mon30_40)
process.path40_50= cms.Path(process.hltMB*process.eventSelection*process.centralityBin*process.Centrality40_50*process.QWEvent*process.Mon40_50)
process.path50_60= cms.Path(process.hltMB*process.eventSelection*process.centralityBin*process.Centrality50_60*process.QWEvent*process.Mon50_60)
process.path60_70= cms.Path(process.hltMB*process.eventSelection*process.centralityBin*process.Centrality60_70*process.QWEvent*process.Mon60_70)
process.path70_80= cms.Path(process.hltMB*process.eventSelection*process.centralityBin*process.Centrality70_80*process.QWEvent*process.Mon70_80)
process.path80_90= cms.Path(process.hltMB*process.eventSelection*process.centralityBin*process.Centrality80_90*process.QWEvent*process.Mon80_90)
process.path90_100=cms.Path(process.hltMB*process.eventSelection*process.centralityBin*process.Centrality90_100*process.QWEvent*process.Mon90_100)

process.output = cms.OutputModule("PoolOutputModule",
	outputCommands = cms.untracked.vstring('keep *_QWEvent_*_*'),
