...
process.clusterCompatibilityFilterCut20 = process.clusterCompatibilityFilter.clone( clusterTrunc  = cms.double(2.0) )
process.clusterCompatibilityFilterCut23 = process.clusterCompatibilityFilter.clone( clusterTrunc  = cms.double(2.3) )
process.clusterCompatibilityFilterCut26 = process.clusterCompatibilityFilter.clone( clusterTrunc  = cms.double(2.6) )
process.clusterCompatibilityFilterCut29 = process.clusterCompatibilityFilter.clone( clusterTrunc  = cms.double(2.9) )
process.clusterCompatibilityFilterCut32 = process.clusterCompatibilityFilter.clone( clusterTrunc  = cms.double(3.2) )
process.clusterCompatibilityFilterCut35 = process.clusterCompatibilityFilter.clone( clusterTrunc  = cms.double(3.5) )
process.clusterCompatibilityFilterCut38 = process.clusterCompatibilityFilter.clone( clusterTrunc  = cms.double(3.8) )
process.clusterCompatibilityFilterCut41 = process.clusterCompatibilityFilter.clone( clusterTrunc  = cms.double(4.1) )
