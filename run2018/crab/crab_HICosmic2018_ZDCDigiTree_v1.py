...
config.General.requestName = 'HIMB1A_ZDCDigiTree_v1'
...
config.Data.lumiMask = 'cosmics_json.txt'
...
#
#
#config.General.requestName = 'HIMB2A_ZDCDigiTree_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB3A_ZDCDigiTree_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB4A_ZDCDigiTree_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB5A_ZDCDigiTree_v1'
...
#config.General.requestName = 'HIMB6A_ZDCDigiTree_v1'
...
#
#
#config.General.requestName = 'HIMB7A_ZDCDigiTree_v1'
...
#
#
#config.General.requestName = 'HIMB8A_ZDCDigiTree_v1'
...
#
#
#config.General.requestName = 'HIMB9A_ZDCDigiTree_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB10A_ZDCDigiTree_v1'
...
config.General.requestName = 'HIMB0A_ZDCDigiTree_v1'
...
config.General.requestName = 'HIMB11A_ZDCDigiTree_v1'
...
config.General.requestName = 'HIMB12A_ZDCDigiTree_v1'
...
config.General.requestName = 'HIMB13A_ZDCDigiTree_v1'
...
config.General.requestName = 'HIMB14A_ZDCDigiTree_v1'
...
config.General.requestName = 'HIMB15A_ZDCDigiTree_v1'
...
config.General.requestName = 'HIMB16A_ZDCDigiTree_v1'
...
config.General.requestName = 'HIMB17A_ZDCDigiTree_v1'
...
config.General.requestName = 'HIMB18A_ZDCDigiTree_v1'
...
config.General.requestName = 'HIMB19A_ZDCDigiTree_v1'
